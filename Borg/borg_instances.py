...
instancesType = ["sphere/sphere","ellipsoide separable/ellipsoide separable","attractive sector/attractive sector",
                 "rosenbrock original/rosenbrock original","sharp ridge/shap ridge","sum of different powers/sum of different powers",
...
for k in range(len(instancesNbr)):
    for j in range(len(instancesD)):
        ...
        # Read the data
        with open("./Data/bbob-biobj_f"+instancesNbr[k]+"_d"+instancesD[j]+"_hyp.tdat", "r") as file:
            for line in file:
        ...
        plt.savefig("Instances/"+picName+"_f"+instancesNbr[k]+"_d"+instancesD[j]+"_instances.png")
        plt.close()
        ...
        plt.savefig("Median/"+picName+"_f"+instancesNbr[k]+"_d"+instancesD[j]+"_median.png")
        plt.close()
        ...
        plt.savefig("ECDF/"+picName+"_f"+instancesNbr[k]+"_d"+instancesD[j]+"_ecdf.png")
        plt.close()
